...
object predef:
  private[libjni] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object enumerations:
  import predef.*
  /**
   * [bindgen] header: /Library/Java/JavaVirtualMachines/temurin-21.jdk/Contents/Home/include/jni.h
  */
...
object aliases:
  import _root_.libjni.enumerations.*
  import _root_.libjni.predef.*
  import _root_.libjni.aliases.*
  import _root_.libjni.structs.*
  import _root_.libjni.unions.*
  /**
   * [bindgen] header: /Library/Java/JavaVirtualMachines/temurin-21.jdk/Contents/Home/include/jni.h
  */
  ...
  */
  ...
  /**
   * [bindgen] header: /Library/Java/JavaVirtualMachines/temurin-21.jdk/Contents/Home/include/darwin/jni_md.h
  */
...
@extern
private[libjni] object extern_functions:
  import _root_.libjni.enumerations.*
  import _root_.libjni.predef.*
  import _root_.libjni.aliases.*
  import _root_.libjni.structs.*
...
object types:
  export _root_.libjni.structs.*
  export _root_.libjni.aliases.*
  export _root_.libjni.unions.*
  export _root_.libjni.enumerations.*

object all:
  export _root_.libjni.enumerations._jobjectType
  export _root_.libjni.aliases.JNIEnv
  export _root_.libjni.aliases.JavaVM
  export _root_.libjni.aliases.jarray
  export _root_.libjni.aliases.jboolean
  export _root_.libjni.aliases.jbooleanArray
  export _root_.libjni.aliases.jbyte
  export _root_.libjni.aliases.jbyteArray
  export _root_.libjni.aliases.jchar
  export _root_.libjni.aliases.jcharArray
  export _root_.libjni.aliases.jclass
  export _root_.libjni.aliases.jdouble
  export _root_.libjni.aliases.jdoubleArray
  export _root_.libjni.aliases.jfieldID
  export _root_.libjni.aliases.jfloat
  export _root_.libjni.aliases.jfloatArray
  export _root_.libjni.aliases.jint
  export _root_.libjni.aliases.jintArray
  export _root_.libjni.aliases.jlong
  export _root_.libjni.aliases.jlongArray
  export _root_.libjni.aliases.jmethodID
  export _root_.libjni.aliases.jobject
  export _root_.libjni.aliases.jobjectArray
  export _root_.libjni.aliases.jobjectRefType
  export _root_.libjni.aliases.jshort
  export _root_.libjni.aliases.jshortArray
  export _root_.libjni.aliases.jsize
  export _root_.libjni.aliases.jstring
  export _root_.libjni.aliases.jthrowable
  export _root_.libjni.aliases.jweak
  export _root_.libjni.aliases.va_list
  export _root_.libjni.structs.JNIEnv_
  export _root_.libjni.structs.JNIInvokeInterface_
  export _root_.libjni.structs.JNINativeInterface_
  export _root_.libjni.structs.JNINativeMethod
  export _root_.libjni.structs.JavaVMAttachArgs
  export _root_.libjni.structs.JavaVMInitArgs
  export _root_.libjni.structs.JavaVMOption
  export _root_.libjni.structs.JavaVM_
  export _root_.libjni.structs._jfieldID
  export _root_.libjni.structs._jmethodID
  export _root_.libjni.structs._jobject
  export _root_.libjni.unions.jvalue
  export _root_.libjni.functions.JNI_CreateJavaVM
  export _root_.libjni.functions.JNI_GetCreatedJavaVMs
  export _root_.libjni.functions.JNI_GetDefaultJavaVMInitArgs
  export _root_.libjni.functions.JNI_OnLoad
  export _root_.libjni.functions.JNI_OnUnload